...
BUILTINS = {
    ...
    for function in (
        ...
        *(BuiltinFunction(category, 1, 1, _error_constructor(category)) for category in (
            ...
            , "network_error", "network_dns_error", "network_interface_error", "network_connection_error", "network_timeout_error", "network_limit_error", "network_closed_error", "network_protocol_error", "network_operation_unavailable", "network_address_error", "network_service_error", "dhcp_server_error", "dns_server_error", "wifi_access_point_error"
        )),
