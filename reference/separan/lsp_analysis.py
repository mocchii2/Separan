...
BUILTIN_SIGNATURES = {
    ...
    "gpio_set_mode": "gpio_set_mode(pin: pin, mode: string) -> null",
    "gpio_write": "gpio_write(pin: pin, value: boolean) -> null",
    "gpio_read": "gpio_read(pin: pin) -> boolean",
    "analog_read": "analog_read(pin: pin) -> number",
    "analog_write": "analog_write(pin: pin, value: number) -> null",
    "pwm_write": "pwm_write(pin: pin, duty_cycle: number) -> null",
