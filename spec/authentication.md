...
HMAC-SHA256, HS256-only JWT signing and verification, and salted scrypt password
hashing.
...
runtime clock. Secret or bytes claims are rejected. Password storage uses a
random 16-byte salt and scrypt N=16384, r=8, p=1; raw SHA-256 is deliberately not
a password API.
