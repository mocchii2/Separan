...
SYNTAX_CASES = (
    ...
    ("decomposed_unicode_label", "SEP:main\nif true :cafe\u0301\nendif:cafe\u0301\nEND_SEP:main\n", "E102"),
    ("unterminated_comment", "##note\nignored\n", "E106"),
    ("comment_label_mismatch", "##note\nignored\n##other\n", "E104"),
    ("bare_function_tag", "SEP:main\n@\nEND_SEP:main\n", "E216"),
    ("tag_outside_function", "@notification\nSEP:main\nEND_SEP:main\n", "E216"),
    ("tag_after_statement", 'SEP:main\nprint "x"\n@notification\nEND_SEP:main\n', "E217"),
    ("duplicate_function_tag", "SEP:main\n@notification\n@notification\nEND_SEP:main\n", "E218"),
    ("incomplete_structural_token", "SEP:main\n:end\nEND_SEP:main\n", "E122"),
    ...
    ("nested_function", "SEP:main\nSEP:child\nEND_SEP:child\nEND_SEP:main\n", "E110"),
    ("nested_import", 'SEP:main\nimport "child.sep" as child\nEND_SEP:main\n', "E703"),
    ("late_import", 'value = 1\nimport "child.sep" as child\n', "E702"),
    ("nested_error_declaration", "SEP:main\nerror:child_error\nend_error:child_error\nEND_SEP:main\n", "E120"),
    ...
    ("duplicate_catch", "SEP:main\ntry :work\ncatch io_error :work\ncatch io_error :work\nendtry:work\nEND_SEP:main\n", "E117"),
    ("catch_after_any", "SEP:main\ntry :work\ncatch any :work\ncatch io_error :work\nendtry:work\nEND_SEP:main\n", "E118"),
    ("try_without_handler", "SEP:main\ntry :work\nendtry:work\nEND_SEP:main\n", "E119"),
    ("duplicate_parameter", "SEP:work(value, value)\nEND_SEP:work\n", "E112"),
    ("duplicate_named_argument", "print missing(value = 1, value = 2)\n", "E113"),
    ("positional_after_named", "print missing(value = 1, 2)\n", "E114"),
    ("chained_equal", "SEP:main\nif 1 == 1 == 1 :condition\nendif:condition\nEND_SEP:main\n", "E111"),
    ("chained_not_equal", "SEP:main\nif 1 != 2 != 3 :condition\nendif:condition\nEND_SEP:main\n", "E111"),
    ("chained_less", "SEP:main\nif 1 < 2 < 3 :condition\nendif:condition\nEND_SEP:main\n", "E111"),
    ("mixed_comparison_chain", "SEP:main\nif 1 < 2 == true :condition\nendif:condition\nEND_SEP:main\n", "E111"),
    ("second_else", "SEP:main\nif true :choice\nelse:choice\nelse:choice\nendif:choice\nEND_SEP:main\n", "E108"),
    ("elseif_after_else", "SEP:main\nif true :choice\nelse:choice\nelseif false :choice\nendif:choice\nEND_SEP:main\n", "E108"),
    ("unexpected_endif", "endif:missing\n", "E107"),
    ("unexpected_endwhile", "endwhile:missing\n", "E107"),
    ("unexpected_endfor", "endfor:missing\n", "E107"),
    ("unexpected_end_function", "END_SEP:missing\n", "E107"),
    ("unclosed_function", "SEP:main\n", "E106"),
    ("unclosed_if", "SEP:main\nif true :condition\n", "E106"),
    ("unclosed_while", "SEP:main\nwhile true :loop\n", "E106"),
    ("unclosed_for", "SEP:main\nfor item in [] :items\n", "E106"),
    ("if_label_mismatch", "SEP:main\nif true :right\nendif:wrong\nEND_SEP:main\n", "E104"),
    ("elseif_label_mismatch", "SEP:main\nif false :right\nelseif true :wrong\nendif:right\nEND_SEP:main\n", "E104"),
    ("else_label_mismatch", "SEP:main\nif false :right\nelse:wrong\nendif:right\nEND_SEP:main\n", "E104"),
    ("while_kind_mismatch", "SEP:main\nwhile true :loop\nendif:loop\nEND_SEP:main\n", "E105"),
    ("nested_block_wrong_order", "SEP:main\nif true :outer\nwhile true :inner\nendif:outer\nendwhile:inner\nEND_SEP:main\n", "E105"),
    ("duplicate_open_label", "SEP:main\nif true :main\nendif:main\nEND_SEP:main\n", "E109"),
    ("reserved_system_assignment", "system = 1\n", "E215"),
    ("reserved_system_parameter", "SEP:work(system)\nEND_SEP:work\n", "E215"),
...
RUNTIME_CASES = (
    ...
    ("duplicate_function", "SEP:work\nEND_SEP:work\nSEP:work\nEND_SEP:work\n", "E204"),
    ("main_with_parameter", "SEP:main(value)\nEND_SEP:main\n", "E205"),
    ("builtin_redefinition", "SEP:length\nEND_SEP:length\n", "E209"),
    ...
    ("user_function_too_few", "SEP:work(value)\nreturn value\nEND_SEP:work\nprint work()\n", "E207"),
    ("user_function_too_many", "SEP:work(value)\nreturn value\nEND_SEP:work\nprint work(1, 2)\n", "E207"),
    ("user_function_named_argument", "SEP:work(value)\nreturn value\nEND_SEP:work\nprint work(value = 1)\n", "E207"),
    ("parameter_type_changed", 'SEP:echo(value)\nreturn value\nEND_SEP:echo\nprint echo(1)\nprint echo("one")\n', "E208"),
    ("if_condition_not_boolean", "SEP:main\nif 1 :condition\nendif:condition\nEND_SEP:main\n", "E201"),
    ("while_condition_not_boolean", "SEP:main\nwhile 1 :loop\nendwhile:loop\nEND_SEP:main\n", "E201"),
    ("for_target_not_list", "SEP:main\nfor item in 1 :items\nendfor:items\nEND_SEP:main\n", "E201"),
